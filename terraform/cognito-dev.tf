# locals {
#   domain_dev = "http://localhost:5500/"
# }

# resource "aws_cognito_user_pool" "dev_user_pool" {
#   name = "commercial-bank-service-users-dev"
...
#   callback_urls                        = [local.domain_dev]
#   default_redirect_uri                 = local.domain_dev
...
#   domain = "commercial-bank-service-dev"
